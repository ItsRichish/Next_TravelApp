...
const Camp = () => {
  return (
    <section className="2xl:max-container relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20">
      <div className="h-[340px] w-full hide-scrollbar flex justify-start items-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[640px]">
        <CampSite
      ...
      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
        <div className="relative w-full overflow-hidden rounded-3xl bg-green-50 p-8 lg:max-w-[500px] xl:max-w-[734px] xl:rounded-5xl xl:px-16 xl:py-20">
          ...
          <p className="mt-5 text-white regular-14 xl:regular-16">
            ...
            climbing location, the possiblity of getting lost is very large.
